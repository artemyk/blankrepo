...
exec(open(c_dir + '/../%s/version.py'%project).read())
...
latex_documents = [
  ('index', 'PKG.tex', u'PKG Documentation',
...
texinfo_documents = [
  ('index', 'PKG', u'PKG Documentation',
   u'Artemy Kolchinsky', 'PKG', 'One line description of project.',
   'Miscellaneous'),
]
